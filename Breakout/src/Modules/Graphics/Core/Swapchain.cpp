#include "stdafx.h"
#include "Modules/Graphics/Core/Swapchain.h"

VulkanSwapChain::VulkanSwapChain(const graphics::VulkanContext& context) : context(context) {}

void VulkanSwapChain::initSurface(HINSTANCE platformHandle, HWND platformWindow, std::string name)
{
...
void VulkanSwapChain::setup(vk::CommandBuffer cmdBuffer, uint32_t *width, uint32_t *height)
{
