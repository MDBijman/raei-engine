#include "stdafx.h"
#include "Game/Systems/BallSystem.h"

void systems::ball_system::update(ecs_manager& ecs)
{
...
void systems::ball_system::bounce(ecs_manager& ecs, uint32_t block, uint32_t ball)
{
